...
def read_credentials_file_from_s3(user_id):
    """
    ...
    """
    bucket_name = fp.ROOT_BUCKET
    object_name = fp.USER_EMAIL_SERVICE_ACCOUNT_PATH.format(user_id=user_id)
    credentials_file = read_json_from_s3(bucket_name, object_name)
